...
println(
  List(
    ...
    FunctionProgress.from("append", Todo, Todo, Easy, comment = "Refactor tests to compare LazyLists directly (Eq[LazyList])"),
    ...
    FunctionProgress.from("flatten", Todo, Todo, Easy, comment = "Refactor tests to compare LazyLists directly (Eq[LazyList])"),
    ...
    FunctionProgress.from("drop", Done, Todo, Easy, comment = "Refactor tests to compare LazyLists directly (Eq[LazyList])"),
