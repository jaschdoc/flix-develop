...
println(
  List(
    ...
    FunctionProgress.from("foreach", Done, Todo, Easy, comment = "Dependent on other PRs, but is implemented"),
    FunctionProgress.from("forall", Done, Todo, Easy, comment = "Dependent on other PRs, but is implemented"),
